...
Estas 173 migraciones provienen del repositorio de origen
(`ferreteria-republica-erp`, rama `main`) y se conservan
...
2. **Efecto multi-tenant.** 21 de ellas iteran sobre `pg_namespace` y aplican
