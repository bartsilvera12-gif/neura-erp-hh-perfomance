 ...
 */
/**
 * Handler compartido de creación del borrador `factura_electronica`.
 *
 * Extraído de la ruta HTTP para que el encolador y el worker de
 * `sifen_jobs` puedan invocarlo headless. La ruta queda como wrapper.
 */
