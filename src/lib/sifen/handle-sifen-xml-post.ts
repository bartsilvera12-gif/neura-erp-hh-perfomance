 ...
 */
/**
 * Handler compartido de generación de XML rDE.
 *
 * Extraído de la ruta HTTP para que el worker de `sifen_jobs` pueda invocarlo
 * headless (sin red, sin cookies) igual que hacen enviar/consulta-lote. La
 * ruta queda como wrapper delgado que resuelve auth y delega acá.
 */
