...
/**
 * Instancia monocliente: se restringe al schema propio.
 *
 * La versión multi-tenant original recorría `pg_namespace` y devolvía todos los
 * schemas con `chat_campaign_recipients`, lo que en una base compartida
 * alcanzaría a los schemas de otros clientes.
 */
