 ...
 * de la empresa (HH Performance).
 *
 * PENDIENTE: confirmar datos comerciales reales de HH Performance (razón
 * social, RUC, actividad económica SIFEN, teléfono y dirección). Los valores
 * de `telefono` y `direccion` son placeholders hasta recibirlos.
 */

export const EMPRESA_DOC = {
  nombre: "HH Performance",
  actividad: ["Taller de motos y venta de repuestos"],
  telefono: "",
  direccion: ["Paraguay"],
  /** Logo del cliente (alta calidad, sin fondo). Servido desde /public. */
  logoUrl: "/brand/hh-performance-doc-logo.png",
};
